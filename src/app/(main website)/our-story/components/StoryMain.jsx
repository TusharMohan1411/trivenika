...
export default function StoryMain() {
    ...
    return (
        <div className="bg-[#FFFDF7] min-h-screen">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <motion.div variants={itemVariants}>
                            <div className="relative h-80 w-full rounded-2xl overflow-hidden">
                                {/* Replace with image of Triveni Sangam or three rivers */}
                                <Image
                                    src="/rivers.png"
                                    alt="Triveni Sangam"
                                    fill
            ...
            {/* Footer CTA */}
            <div className="bg-[#f8fbf3] py-16 text-center">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <button className="bg-[#2E8B57] hover:bg-[#256e46] text-white px-8 py-3 rounded-full font-medium transition-all transform hover:scale-105">
