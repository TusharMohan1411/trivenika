...
export default function LabTestingSection({ labTestingImage }) {
    // Animation variants
    ...
    return (
        <section className="bg-[#FFFDF7] px-4 md:px-8 pt-26 md:pt-0 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="relative aspect-square w-full max-w-lg mx-auto">
                            ...
                            >
                                <Image
                                    src={labTestingImage || "/lab-report.png"}
                                    alt="Lab Report"
                                    fill
