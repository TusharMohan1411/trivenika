...
export const ContactForm = () => {
    ...
    return (
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#064e3b] to-emerald-900 p-4 sm:p-8 shadow-2xl">
            {/* Decorative elements */}
            <div className="absolute top-0 left-0 w-full h-full">
                <div className="absolute top-10 -right-10 w-40 h-40 rounded-full bg-emerald-500/20"></div>
                <div className="absolute bottom-20 -left-10 w-60 h-60 rounded-full bg-emerald-600/20"></div>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full py-3 pl-10 pr-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-400 bg-white/90 backdrop-blur-sm text-gray-800 placeholder-gray-500 transition-all duration-300"
                                required
                            />
                        </div>
