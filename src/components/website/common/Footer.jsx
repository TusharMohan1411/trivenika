                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-md">Kirdhan Rd, Dhingsara, Haryana, India</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-md">contact@trivenika.com</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300 text-md">+91 8569996206</p>
                            </div>
                        </div>
                    </div>
                </div>
